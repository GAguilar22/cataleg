...
{
    //ATRIBUTOS DE LA CLASE CATALEG CONTROLLER
    ...
    private $arrayPeliculas = array(
		array(
			...
			'poster' => 'https://i.etsystatic.com/43710319/r/il/1fb162/6066629614/il_794xN.6066629614_s3fc.jpg', 
			'rented' => false, 
		...
		array(
			...
			'year' => '1974', 
			'director' => 'Francis Ford Coppola', 
			'poster' => 'https://i.ebayimg.com/images/g/WfUAAOSw44Zj8lry/s-l1600.webp', 
			'rented' => false, 
		...
		array(
			...
			'poster' => 'https://m.media-amazon.com/images/I/81h1lTySL-L._AC_SL1500_.jpg', 
			'rented' => false, 
		...
		array(
			...
			'poster' => 'https://m.media-amazon.com/images/I/71mlgE7nUdL._AC_SL1024_.jpg', 
			'rented' => true, 
		...
		array(
			...
			'poster' => 'https://m.media-amazon.com/images/I/91RaQEbnbGL._AC_SL1500_.jpg', 
			'rented' => true, 
		...
		array(
			...
			'poster' => 'https://m.media-amazon.com/images/I/71UXFUxbauL._AC_SL1500_.jpg', 
			'rented' => false, 
		...
		array(
			...
			'poster' => 'https://m.media-amazon.com/images/I/71Oa2RRRcRL._AC_SL1500_.jpg', 
			'rented' => false, 
		...
		array(
			...
			'poster' => 'https://m.media-amazon.com/images/I/711SQPhIExL._AC_SL1500_.jpg', 
			'rented' => false, 
		...
		array(
			...
			'year' => '1998', 
			'director' => 'Tony Kaye', 
			'poster' => 'https://m.media-amazon.com/images/I/819ZfaRvMoL._AC_SL1500_.jpg', 
			'rented' => false, 
		...
		array(
			...
			'poster' => 'https://image.tmdb.org/t/p/original/bhcVwMko4DbSELZapIQv4mmdPKY.jpg', 
			'rented' => false, 
		...
		array(
			...
			'poster' => 'https://m.media-amazon.com/images/I/6119F9LKIiL._SL1129_.jpg', 
			'rented' => false, 
		...
		array(
			...
			'poster' => 'https://m.media-amazon.com/images/I/41R9mgGiXDL._AC_.jpg', 
			'rented' => true, 
		...
		array(
			...
			'poster' => 'https://m.media-amazon.com/images/I/815VVAvdgDL._AC_SL1500_.jpg', 
			'rented' => true, 
		...
		array(
			...
			'poster' => 'https://m.media-amazon.com/images/I/A1ZJo47mGUL._AC_SL1500_.jpg', 
			'rented' => false, 
		...
		array(
			...
			'poster' => 'https://m.media-amazon.com/images/I/61jX1pxQ9aL._AC_SL1500_.jpg', 
			'rented' => false, 
		...
		array(
			...
			'year' => '1987', 
			'director' => 'Stanley Kubrick', 
			'poster' => 'https://m.media-amazon.com/images/I/71cOsQbWOiL._AC_SL1500_.jpg', 
			'rented' => true, 
		...
		array(
			...
			'poster' => 'https://i.ebayimg.com/images/g/c3gAAOxygPtS3nvr/s-l1600.webp', 
			'rented' => true, 
		...
		array(
			...
			'year' => '1976', 
			'director' => 'Martin Scorsese', 
			'poster' => 'https://m.media-amazon.com/images/I/91dtPf9mlZL._AC_SL1500_.jpg', 
			'rented' => false, 
		...
		array(
			...
			'year' => '1999', 
			'director' => 'David Fincher', 
			'poster' => 'https://m.media-amazon.com/images/I/71UUUCm0qoL._AC_SL1426_.jpg', 
			'rented' => true, 
    ...
    {
		self::seedUsers();
		$this->command->info('Taula usuaris iniciada amb dades!');  
	...
	private function seedUsers(): void{
		...
		/*Per a poder utilitzar aquest mètode per afegir usuaris manualment
		Necessitem afegir al apartat de app/Models/User.php
		Si no volem utilitzar aquests camps, els podem modificar sense problema
		protected $fillable = [
        'name',
        'email',
        'password',
		...
		*/
		$user =new User();
		$user->name = 'Didac';
		$user->email = 'didac@gmail.cat';
		$user->password = bcrypt('123456789');
		$user ->save();

		$user = new User();
		$user->name = 'Carles';
		$user->email = 'carles@gmail.cat';
		$user->password = bcrypt('12345678');
		$user->save();

		$user = new User();
		$user->name = 'David';
		$user->email = 'david@gmail.cat';
